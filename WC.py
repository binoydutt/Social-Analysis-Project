...
txt2 = ''
for twt in tweets:
    tx = unicodedata.normalize('NFKD', twt).encode('ascii','ignore') #Stackoverflow
...
ignore_words = ['RT', 'rt','http', 'https', 'trump','donald', 'realdonaldtrump', 'thi', 'amp','hi','whi','co','ha','potus','potu','wa']
